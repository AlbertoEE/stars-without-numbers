...
import type EquipmentDefinitionRepository from "@/data/Equipment/EquipmentRepository"
...
export const attributeDefinitionRepository: AttributeDefinitionRepository =
  new InMemoryAttributeDefinitionRepository()
export const skillsDefinitionRepository: SkillDefinitionRepository =
  new InMemorySkillDefinitionRepository()
export const backgroundDefinitionRepository: BackgroundDefinitionRepository =
  new InMemoryBackgroundDefinitionRepository()
export const gameClassDefinitionRepository: GameClassDefinitionRepository =
