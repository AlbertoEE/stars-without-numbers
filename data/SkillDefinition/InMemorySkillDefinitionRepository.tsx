import {
  ...
  StandardSkillDefinitionType,
} from "@/models/StandardSkillDefinitionModels"
...
const skillDefinitions: StandardSkillDefinition[] = [
  {
    name: "administer",
    description:
    ...
    shortDescription:
      "Manage an organization, handle paperwork, analyze records, and keep an institution functioning on a daily basis.",
    type: [StandardSkillDefinitionType.any],
  },
  {
    name: "connect",
    description:
  ...
  },
  {
    ...
    type: [StandardSkillDefinitionType.any, StandardSkillDefinitionType.combat],
  },
  {
    name: "shoot",
    description:
