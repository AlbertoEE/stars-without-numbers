    ...
    benefits: {
      ...
      predifined: [
        ...
        },
        {
          type: BackgroundBenefitType.skill,
          name: "combat skill",
          subtype: StandardSkillDefinitionType.combat,
        },
      ],
      growth: [
        {
          type: BackgroundBenefitType.stat,
          name: "any stat",
          amount: 1,
          subtype: AttributeDefinitionType.any,
        },
        {
          type: BackgroundBenefitType.stat,
          name: "physical stat",
          amount: 2,
          subtype: AttributeDefinitionType.physical,
        },
        {
          type: BackgroundBenefitType.stat,
          name: "physical stat",
        ...
        },
        {
          ...
          name: "mental stat",
          amount: 2,
          subtype: AttributeDefinitionType.mental,
        },
        {
          type: BackgroundBenefitType.skill,
          name: "exert",
        ...
        },
        {
          type: BackgroundBenefitType.skill,
          name: "any skill",
          subtype: StandardSkillDefinitionType.any,
        },
      ],
      learning: [
        {
