...
const backgroundDefinitions: BackgroundDefinition[] = [
    {
      ...
      benefits: {
        ...
        quick: [
          ...
          { type: BackgroundBenefitType.skill, name: "combat skill" },
        ],
        growth: [
          { type: BackgroundBenefitType.stat, name: "any stat", amount: 1 },
          { type: BackgroundBenefitType.stat, name: "physical stat", amount: 2 },
          { type: BackgroundBenefitType.stat, name: "physical stat", amount: 2 },
          { type: BackgroundBenefitType.stat, name: "mental stat", amount: 2 },
    ...
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "combat skill" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "combat skill" },
          { type: BackgroundBenefitType.skill, name: "exert" },
          { type: BackgroundBenefitType.skill, name: "survive" },
