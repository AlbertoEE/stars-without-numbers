...
const backgroundDefinitions: BackgroundDefinition[] = [
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "survive" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "survive" },
          { type: BackgroundBenefitType.skill, name: "notice" },
          { type: BackgroundBenefitType.skill, name: "combat" },
        ],
        growth: [
          { type: BackgroundBenefitType.stat, name: "any", amount: 1 },
          { type: BackgroundBenefitType.stat, name: "physical", amount: 2 },
          { type: BackgroundBenefitType.stat, name: "physical", amount: 2 },
          { type: BackgroundBenefitType.stat, name: "mental", amount: 2 },
          { type: BackgroundBenefitType.skill, name: "Exert" },
          { type: BackgroundBenefitType.skill, name: "Any Skill" },
        ],
        learning: [
          { type: BackgroundBenefitType.skill, name: "combat" },
          { type: BackgroundBenefitType.skill, name: "connect" },
          { type: BackgroundBenefitType.skill, name: "exert" },
          { type: BackgroundBenefitType.skill, name: "lead" },
          { type: BackgroundBenefitType.skill, name: "notice" },
          { type: BackgroundBenefitType.skill, name: "punch" },
          { type: BackgroundBenefitType.skill, name: "sneak" },
          { type: BackgroundBenefitType.skill, name: "survive" },
        ],
      },
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "talk" }],
        quick: [
    ...
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "sneak" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "perform" },
          { type: BackgroundBenefitType.skill, name: "notice" },
          { type: BackgroundBenefitType.skill, name: "talk" },
        ...
        growth: [
          ...
          { type: BackgroundBenefitType.stat, name: "mental", amount: 2 },
          { type: BackgroundBenefitType.stat, name: "mental", amount: 2 },
          { type: BackgroundBenefitType.stat, name: "physycal", amount: 2 },
          { type: BackgroundBenefitType.skill, name: "Connect" },
          { type: BackgroundBenefitType.skill, name: "Any Skill" },
        ],
        learning: [
    ...
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "connect" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "connect" },
          { type: BackgroundBenefitType.skill, name: "perform" },
          { type: BackgroundBenefitType.skill, name: "talk" },
        ...
        growth: [
          { type: BackgroundBenefitType.stat, name: "any", amount: 1 },
          { type: BackgroundBenefitType.stat, name: "any Stat", amount: 1 },
          { type: BackgroundBenefitType.stat, name: "any", amount: 1 },
          { type: BackgroundBenefitType.stat, name: "any", amount: 1 },
          { type: BackgroundBenefitType.skill, name: "Connect" },
          { type: BackgroundBenefitType.skill, name: "Any Skill" },
        ...
        learning: [
          ...
          { type: BackgroundBenefitType.skill, name: "connect" },
          { type: BackgroundBenefitType.skill, name: "notice" },
          { type: BackgroundBenefitType.skill, name: "program" },
          { type: BackgroundBenefitType.skill, name: "sneak" },
          { type: BackgroundBenefitType.skill, name: "talk" },
          { type: BackgroundBenefitType.skill, name: "trade" },
        ],
    ...
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "perform" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "perform" },
          { type: BackgroundBenefitType.skill, name: "talk" },
          { type: BackgroundBenefitType.skill, name: "connect" },
    ...
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "trade" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "trade" },
          { type: BackgroundBenefitType.skill, name: "talk" },
          { type: BackgroundBenefitType.skill, name: "connect" },
    ...
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "lead" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "lead" },
          { type: BackgroundBenefitType.skill, name: "connect" },
          { type: BackgroundBenefitType.skill, name: "administer" },
        ...
        learning: [
          ...
          { type: BackgroundBenefitType.skill, name: "lead" },
          { type: BackgroundBenefitType.skill, name: "notice" },
          { type: BackgroundBenefitType.skill, name: "pilot" },
          { type: BackgroundBenefitType.skill, name: "talk" },
        ],
      },
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "administer" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "administer" },
          { type: BackgroundBenefitType.skill, name: "talk" },
          { type: BackgroundBenefitType.skill, name: "connect" },
        ...
        learning: [
          { type: BackgroundBenefitType.skill, name: "administer" },
          { type: BackgroundBenefitType.skill, name: "anySkill" },
          { type: BackgroundBenefitType.skill, name: "connect" },
          { type: BackgroundBenefitType.skill, name: "perform" },
          { type: BackgroundBenefitType.skill, name: "lead" },
          { type: BackgroundBenefitType.skill, name: "notice" },
    ...
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "exert" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "exert" },
          { type: BackgroundBenefitType.skill, name: "sneak" },
          { type: BackgroundBenefitType.skill, name: "survive" },
        ...
        learning: [
          ...
          { type: BackgroundBenefitType.skill, name: "survive" },
          { type: BackgroundBenefitType.skill, name: "trade" },
          { type: BackgroundBenefitType.skill, name: "work" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "pilot" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "pilot" },
          { type: BackgroundBenefitType.skill, name: "shoot" },
          { type: BackgroundBenefitType.skill, name: "trade" },
        ],
        growth: [
          { type: BackgroundBenefitType.stat, name: "any", amount: 1 },
    ...
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "combat" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "combat" },
          { type: BackgroundBenefitType.skill, name: "exert" },
          { type: BackgroundBenefitType.skill, name: "survive" },
    ...
    },
    {
      ...
      benefits: {
        free: [{ type: BackgroundBenefitType.skill, name: "work" }],
        quick: [
          { type: BackgroundBenefitType.skill, name: "work" },
          { type: BackgroundBenefitType.skill, name: "connect" },
          { type: BackgroundBenefitType.skill, name: "exert" },
