        ...
        abilities: [
            {
                ...
                details: ["You gain a free level in a non-combat focus relat- ed to your background. Most concepts will take Specialist in their main skill, though Diplomat, Star- farer, Healer, or some other focus might suit better. You may not take a combat-oriented focus with this perk."]
            },
            {
                summary: "Re-roll Skill Checks",
                details: ["Once per scene, you can reroll a failed skill check, taking the new roll if it’s better."]
            },
            {
                summary: "Extra Skill Points",
                details: ["When you advance an experience level, you gain a bonus skill point that can be spent on any non-combat, non-psychic skill. You can save this point to spend later if you wish."]
            }
        ],
        ...
        abilities: [
            {
                ...
                details: ["You gain a free level in a combat-related focus as- sociated with your background. "]
            },
            {
            ...
            },
            {
                ...
                details: ["You gain two extra maximum hit points at each character level, including level 1, also, your attack bonus is equal to your character level so it is +1 at first level."]
            }
        ],
        ...
        abilities: [
            {
                ...
                details: ["Unlike Warriors or Experts, you are capable of learning psychic disciplines and their associated techniques"]
            },
            {
                summary: "Choose 2 Psychic Core Skills",
                details: ["When you pick this class, choose any two psychic skills as bonus skills. You can pick the same one twice to obtain level-1 proficiency in it and a free level-1 technique from that discipline."]
            },
            {
                summary: "Effort Score",
                details: ["You have an Effort score, which can be used to fuel psychic abilities. Your maximum Effort is equal to 1 plus your highest psychic skill plus the better of your Wisdom or Constitution modifi- ers. Even with a penalty, your maximum Effort cannot be lower than 1."]
            }
        ],
        atackBonusFormula: (level: number) => { return Math.floor(level / 2) },
        hitPointsFormula: (constitutionModifier: number) => {
        ...
        abilities: [
            {
                summary: "",
                details: [
                    "You can choose 2 classes of the ones mentioned below.",
                ]
            },
            {
