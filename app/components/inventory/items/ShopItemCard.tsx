import { Accordion, AccordionItem, CardBody, CardHeader } from "@nextui-org/react"
  ...
  return (
    ...
    >
      ...
      <Accordion isCompact 
        ...
        >
        <AccordionItem hideIndicator title={(
          <div className="relative">
            ...
            <div className={`absolute h-0 bottom-1 w-full flex justify-center transition-all ${descriptionShowing.size > 0 && "rotate-180"}`}>
